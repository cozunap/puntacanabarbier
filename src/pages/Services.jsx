    ...
    <div className="flex flex-col w-full min-h-[60vh] py-section px-6 md:px-12 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto w-full">
        {[
          ...
          <div key={idx} className="bg-navy-light p-8 rounded-md border border-white/5 flex flex-col gap-4 premium-hover group relative overflow-hidden">
            ...
            <p className="font-sans text-gray-400 font-light relative z-10">{service.desc}</p>
          </div>
        ))}
      </div>
    </div>
